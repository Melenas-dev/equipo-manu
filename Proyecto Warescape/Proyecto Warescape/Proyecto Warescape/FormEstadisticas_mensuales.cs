...
namespace Proyecto_Warescape
{
    public partial class FormEstadisticas_mensuales : Form
    {
        ...
        private void estadisticas_mensuales_MouseDown(object sender, MouseEventArgs e)
        {
